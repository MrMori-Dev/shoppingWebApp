    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="col">
            <div class="card h-100">
                <img src="https://via.placeholder.com/150" class="card-img-top" alt="کالا 1">
                <div class="card-body">
                ...
                <div class="card-footer">
                    ...
                    <a href="../../home/orderItems/add/{{$data[1]['id']}}">
                        <button class="btn btn-primary btn-sm float-end">افزودن به سبد</button>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card h-100">
                <img src="https://via.placeholder.com/150" class="card-img-top" alt="کالا 2">
                <div class="card-body">
        ...
        <div class="col">
            <div class="card h-100">
                <img src="https://via.placeholder.com/150" class="card-img-top" alt="کالا 3">
                <div class="card-body">
